                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.news.store') }}" method="POST">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="content_cs" id="content_cs" rows="12" required
                                              class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('content_cs') }}</textarea>
                                    @error('content_cs')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="content_en" id="content_en" rows="12" required
                                              class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('content_en') }}</textarea>
                                    @error('content_en')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="mt-8 space-y-4">
                            ...
                            <div id="publish_date_container" class="{{ old('is_published') ? '' : 'hidden' }}">
